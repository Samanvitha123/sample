...
String user2 = (String) sessionsc.getAttribute("uname");
//JOptionPane.showMessageDialog(null, user);
//String location = (String) sessionsa.getAttribute("location");
String id=request.getParameter("id");
%>
<h1>Welcome To USer<h2><%out.println(user2); %></h2></h1>
    <form method="post" action="suggestcontrol.jsp">
        ID:<input type="text" name="id" value="<%=id%>"></input>
      
        User Name:<input type="text" name="uname" value="<%=user2%>"></input>
