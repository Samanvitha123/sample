...
%>
	<div class="bg1-img">
    <div style="text-align:center"><h1>UNIVERSITY WEB PORTAL </h1> </div>
    <br><center>
...
<%try{
    ...
    ResultSet rs=st.executeQuery("select event_name from service");
    while(rs.next())
    {%>
...
<td width="119"><b>Service</b></td>


</tr>
        <%
        Statement stt=con.createStatement();
        ResultSet rss=stt.executeQuery("select * from joined_service where servicename='"+rs.getString(1)+"'");
        while(rss.next())
        {
            %>
