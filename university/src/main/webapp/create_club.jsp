...
<body>
<%
HttpSession sessionsk = request.getSession(false);
String user7 = (String) sessionsk.getAttribute("uname");
...
%>
    ...
    <br><center>
    <h1>Welcome To admin</h2></h1>
    <form name="form" action="create_club_controller" method="post">
    <table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
<center><tr>
   <td><center><h1>Registration Form For Club</h1></center></td>
</tr><center>
