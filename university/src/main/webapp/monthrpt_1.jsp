...
<%try{
    ...
    ResultSet rs=st.executeQuery("select distinct(ceil(month(dateofevent)/6)) from event");
    while(rs.next())
    {%>
    <h2>Half-yearly Report::::::<%=rs.getString(1)%></h2>
...
<td width="168"><b>Rules</b></td>
        ...
        ResultSet rss=stt.executeQuery("select * from event where month(dateofevent)='"+rs.getString(1)+"'");
        while(rss.next())
        {
            %>
