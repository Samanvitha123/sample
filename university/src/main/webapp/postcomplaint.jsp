...
<div class="bg2-img">
    <center>
        <%
HttpSession sessionse = request.getSession(false);
String user4 = (String) sessionse.getAttribute("uname");
//JOptionPane.showMessageDialog(null, user);
//String location = (String) sessionsa.getAttribute("location");
%>
<h1>Welcome To USer<h2><%out.println(user4); %></h2></h1>
    <form method="post" action="suggestcontrol">
        User Name:<input type="text" name="uname" value="<%=user4%>"></input>
