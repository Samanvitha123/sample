...
<td width="168"><b>Event</b></td>
<td width="119"><b>Description</b></td>
<td width="168"><b>Date</b></td>
<td width="119"><b>Address</b></td>
<td width="168"><b>Phno</b></td>
<td width="119"><b>Mail</b></td>
<td width="168"><b>Rules</b></td>
<td width="168"><b>Complaint</b></td>
<td width="168"><b>Like/Dislike</b></td>
<td width="168"><b>Intrested/Not Intrested</b></td>
<td width="168"><b>Mark Attendance</b></td>
...
<td width="119"><%=itr.next()%></td>
<td width="119"><%=itr.next()%></td>
<td width="119"><a href="complaint.jsp?id=<%=element%>">Complaint</a></td>
<td width="119"><a href="likedislike.jsp?id=<%=element%>">Like/Dislike</a></td>
<td width="119"><a href="intrst.jsp?id=<%=element%>">Intrested/Not Intrested</a></td>
<td width="119"><a href="attend.jsp?id=<%=element%>">Mark Attendance</a></td>
</tr>
<% i++;}
%>
</table>
