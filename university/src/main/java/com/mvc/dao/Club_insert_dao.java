    ...
    public String RegisterEvent(Club evnt)
	{
		 ...
		 Connection con = null;
	        ...
	        try
	        {
	            ...
	            int k = statement.executeUpdate("insert into club(club_name,club_descr) values('"+event_name+"','"+event_descr+"')");//("select userName,password from users"); //the table name is users and userName,password are columns. Fetching all the records and storing in a resultSet.
