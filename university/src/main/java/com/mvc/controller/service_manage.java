 ...
 * @author DELL
 */
public class service_manage extends HttpServlet {
...
out.println("<td bgColor=cyan width=290 height=19><font color=red><b>No of volunteers </b></font></td>");
...
rst=stmt.executeQuery("SELECT * FROM service");
while(rst.next()){
...
//out.println("    <a href="+"serviceedit?id="+rst.getInt(1)+"> Edit Record </a></td>");
out.println("<td bgColor=lightgreen vAlign=top width=230 height=19>");
out.println("    <a href="+"servicedelete?id="+rst.getInt(1)+"> Delete Record </a></td>");
out.println("</tr>");
}else{
out.println("<tr>");
//out.println("<td bgColor=lightgreen vAlign=top width=80 align=center height=19>"+i+"</td>");
