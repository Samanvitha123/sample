...
out.println("<td bgColor=cyan width=290 height=19><font color=red><b>Club Name</b></font></td>");
...
out.println("<td bgColor=cyan width=290 height=19><font color=red><b>Manage Events </b></font></td>");
out.println("<td bgColor=cyan width=290 height=19><font color=red><b>Manage Stories </b></font></td>");
...
rst=stmt.executeQuery("SELECT * FROM club");
while(rst.next()){
if (i==(i/2)*2){
out.println("<tr>");
...
out.println("<a href="+"clubedit?id="+rst.getInt(1)+"> Edit Record </a></td>");
out.println("<td bgColor=lightgreen vAlign=top width=230 height=19>");
out.println("<a href="+"clubdelete?id="+rst.getInt(1)+"> Delete Record </a></td>");
out.println("<td bgColor=lightgreen vAlign=top width=220 height=19 >");
out.println("<a href="+"club_event_create.jsp?id="+rst.getInt(1)+"> Manage Events </a></td>");
out.println("<td bgColor=lightgreen vAlign=top width=220 height=19 >");
out.println("<a href="+"club_story_create.jsp?id="+rst.getInt(1)+"> Manage News Stories </a></td>");
