 ...
 * @author DELL
 */
public class viewclbmembers extends HttpServlet {
...
if (i==(i/2)*2){
out.println("<tr>");
out.println("<td bgColor=lightgreen vAlign=top width=80 align=center height=19>"+rst.getString(1)+"</td>");
...
out.println("    <a href="+"delete_1?id="+rst.getInt(1)+"> Delete Record </a></td>");
out.println("</tr>");
}else{
out.println("<tr>");
