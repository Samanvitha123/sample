 ...
 * @author DELL
 */
public class Service_data_bean extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Service_data_bean() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out = response.getWriter();  
		 ...
		 evnt.setEmail(email);
		 evnt.setRules(rules);
		 EventDao_1 loginDao = new EventDao_1(); //creating object for LoginDao. This class contains main logic of the application.
	        ...
	        if(userValidate.equals("SUCCESS")) //If function returns success string then user will be rooted to Home page
	         ...
	         //    HttpSession session=request.getSession();  
	           //  session.setAttribute("uname",username);
	        	out.println("<script> alert(\"Service Inserted succefully!\");</script>");
