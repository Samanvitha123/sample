...
%>
    ...
    <form name="form" action="club_Event_data_bean" method="post">
    <table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
<center><tr>
   <td><h1>Registration Form For Club events</h1></td>
</tr><center>
 
<table border='0' width='480px' cellpadding='0' cellspacing='0' align='center'>
<tr>
    <td align='center'>Club ID:</td>
    <td><input type='text' name='id' value="<%=clubid%>"></td>
</tr>
...
<tr> <td>&nbsp;</td> </tr>
<tr>
    <td align='center'>Date Of event:</td>
...
<tr> <td>&nbsp;</td> </tr>
<tr>
    <td align='center'>Rules For Event:</td>
