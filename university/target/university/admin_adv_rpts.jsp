...
%>
    ...
    <h2><a href="admin_Events_month_view">Month Events</a> </h2><br></br>
    <h2><a href="admin_Events_halfyrs_view">Half Yearly Events</a> </h2><br></br>
    <h2><a href="admin_Events_yearly_view">Yearly Events</a> </h2><br></br>
